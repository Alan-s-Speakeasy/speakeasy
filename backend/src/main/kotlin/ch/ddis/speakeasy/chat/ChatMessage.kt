...
data class ChatMessage(val message: String, val sessionId: SessionId, val ordinal: Int, val time: Long = System.currentTimeMillis()) {
    ...
    companion object {
        ...
        fun toRestMessages(chatMessages: List<ChatMessage>, sessions: Collection<UserSession>): List<RestChatMessage> =
            chatMessages.mapNotNull { toRestMessage(it, sessions) }
