...
// NOTE : This is fully redudant with the frontend, so should be removed.
...
//        header: FeedbackForm,
//        responses: List<FeedbackResponseOfChatroom>,
//        output: String?,
//        author: Boolean,
//        formName: String,
//    ) {
...
//    fun printSummary(
//        header: FeedbackForm,
//        responses: MutableList<FeedbackResponseOfChatroom>,
//        output: String?,
//        formName: String
//    ) {
//        if (output != null) {
