...
object SessionAliasGenerator {
    ...
    private val leftNames: ArrayList<String>
    private val rightNames: ArrayList<String>

    init {
        leftNames = arrayListOf<String>("admiring",
            "adoring",
            "affectionate",
            "agitated",
            "amazing",
            ...
            "zealous",
            "zen")
        rightNames = arrayListOf<String>(// Maria Gaetana Agnesi - Italian mathematician, philosopher, theologian and humanitarian. She was the first woman to write a mathematics handbook and the first woman appointed as a Mathematics Professor at a University. https://en.wikipedia.org/wiki/Maria_Gaetana_Agnesi
            "agnesi",
    ...
    fun getRandomName(): String {
        ...
        val name = "${leftNames[leftIndex]}_${rightNames[rightIndex]}_${Random.nextInt(100).toString()}"
