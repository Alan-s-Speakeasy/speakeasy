 ...
 */
object SessionAliasGenerator {


    private val leftNames: ArrayList<String> = arrayListOf(
        "admiring",
        "adoring",
        "affectionate",
        "amazing",
    ...
    private val rightNames: ArrayList<String> =
        arrayListOf(// Maria Gaetana Agnesi - Italian mathematician, philosopher, theologian and humanitarian. She was the first woman to write a mathematics handbook and the first woman appointed as a Mathematics Professor at a University. https://en.wikipedia.org/wiki/Maria_Gaetana_Agnesi
            "agnesi",
    ...
    // integer between 0 and 100 will be added to the end of the name, e.g `focused_turing_3`

    fun getRandomName(): String {


        val leftIndex = Random.nextInt(leftNames.size)
        val rightIndex = Random.nextInt(rightNames.size)

        val name = "${leftNames[leftIndex]}_${rightNames[rightIndex]}_${Random.nextInt(100)}"
